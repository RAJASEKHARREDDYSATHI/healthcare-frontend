...
export default class Cancer extends Component {
    ...
    handleConfirmBooking = () => {
        ...
        formData.append('doctorName', "Dr. N. Sagar");
        formData.append('disease', "Kidney");
            ...
            <div className='page-container'>
                ...
                <div className='body-container'>
                    <div className='left-panel'>
                        <h2 className='section-title'>KIDNEY</h2>

                        <div className='booking-info'>
                            <div className='book-label'>BOOK YOUR SLOTS</div>
                            <div className='doctor-name'>Dr. N. Sagar</div>
                        </div>
                ...
                {showModal && (
                    <div className='modal-overlay'>
                        <div className='modal-content'>
                            ...
                            <label>Doctor:</label>
                            <input type='text' value='Dr. N. Sagar' readOnly />

                            <label>Disease:</label>
                            <input type='text' value='Kidney' readOnly />
