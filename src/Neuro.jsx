...
export default class Cancer extends Component {
    ...
    handleConfirmBooking = () => {
        ...
        formData.append('doctorName', "Dr.Jaswanth");
        formData.append('disease', "Neuro");
            ...
            <div className='page-container'>
                ...
                <div className='body-container'>
                    <div className='left-panel'>
                        <h2 className='section-title'>NEUROLOGICAL DISORDERS</h2>

                        <div className='booking-info'>
                            <div className='book-label'>BOOK YOUR SLOTS</div>
                            <div className='doctor-name'>Dr.Jaswanth</div>
                        </div>
                ...
                {showModal && (
                    <div className='modal-overlay'>
                        <div className='modal-content'>
                            ...
                            <label>Doctor:</label>
                            <input type='text' value='Dr.Jaswanth' readOnly />

                            <label>Disease:</label>
                            <input type='text' value='Neuro' readOnly />
