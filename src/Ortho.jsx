...
export default class Cancer extends Component {
    ...
    handleConfirmBooking = () => {
        ...
        formData.append('doctorName', "Dr. K Rohith");
        formData.append('disease', "Orthopetic");
            ...
            <div className='page-container'>
                ...
                <div className='body-container'>
                    <div className='left-panel'>
                        <h2 className='section-title'>ORTHOPETIC DISORDERS</h2>

                        <div className='booking-info'>
                            <div className='book-label'>BOOK YOUR SLOTS</div>
                            <div className='doctor-name'>Dr. K Rohith</div>
                        </div>
                ...
                {showModal && (
                    <div className='modal-overlay'>
                        <div className='modal-content'>
                            ...
                            <label>Doctor:</label>
                            <input type='text' value='Dr. K Rohith' readOnly />

                            <label>Disease:</label>
                            <input type='text' value='Ortho' readOnly />
