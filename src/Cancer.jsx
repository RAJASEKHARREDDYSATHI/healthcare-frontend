...
export default class Cancer extends Component {
    ...
    showFullname = (response) => {
        ...
        if (parts.length > 1) {
            this.setState({ fullname: parts[1] });
        } else {
    ...
    handleSubmit = () => {
        ...
        this.setState({ showModal: true, hasPreviousReports: true });
    };
    ...
    handleConfirmBooking = () => {
        ...
        formData.append('doctorName', "Dr. N. Srikanth");
        formData.append('disease', "Cancer");
        formData.append('appointmentDate', selectedDate); // Ensure this is YYYY-MM-DD
        formData.append('slotTime', selectedSlot);       // Ensure this is HH:mm (24-hour format)
        if (reportLink) {
        ...
        callApi(
            ...
            (errorMessage) => {
                alert("API Error: " + errorMessage); // Display error message to the user
            }
        );
    };
            ...
            <div className='page-container'>
                ...
                <div className='body-container'>
                    <div className='main-content'>
                        <h2 className='section-title'>CANCER</h2>

                        <div className='booking-info'>
                            <div className='book-label'>BOOK YOUR SLOTS</div>
                            <div className='doctor-name'>Dr. N. Srikanth</div>
                        </div>
                        ...
                        <div className='slot-grid'>
                            ...
                            <button className={`slot-btn ${selectedSlot === '14:30' ? 'selected' : ''}`} onClick={() => this.handleSlotClick('14:30')}>14:30</button>
                            <button className={`slot-btn ${selectedSlot === '15:00' ? 'selected' : ''}`} onClick={() => this.handleSlotClick('15:00')}>15:00</button>
                            <button className={`slot-btn ${selectedSlot === '15:30' ? 'selected' : ''}`} onClick={() => this.handleSlotClick('15:30')}>15:30</button>
                        </div>
                ...
                {showModal && (
                    <div className='modal-overlay'>
                        <div className='modal-content'>
                            ...
                            <label>Doctor:</label>
                            <input type='text' value='Dr. N. Srikanth' readOnly />

                            <label>Disease:</label>
                            <input type='text' value='Cancer' readOnly />
                            ...
                            <div className='modal-buttons'>
                                ...
                                <button onClick={() => this.setState({ showModal: false, hasPreviousReports: false, reportLink: '' })}>Cancel</button>
                            </div>
                        </div>
                    </div>
                )}
